...
const WHO_CHIPS = [
  ...
  'Businesses drowning in admin',
  'Anyone chasing invoices manually',
]

const PAIN_POINTS = [
  { icon: '🧾', pain: 'Manually entering receipts and invoices' },
  { icon: '📧', pain: 'Chasing overdue payments by hand' },
  { icon: '📋', pain: "Copying data between systems that don't talk" },
  { icon: '📱', pain: 'Missing leads due to slow response times' },
  { icon: '📊', pain: 'Building reports that should build themselves' },
  { icon: '🔁', pain: 'Same admin tasks, every single week' },
]

const PRIVACY_FAQ = [
  {
    q: 'Where is my data stored?',
    a: "In your own accounts. We connect tools you already use — Google Sheets, Google Drive, Xero, Telegram — and your data stays in those platforms. We don't host or store any of your business data.",
  },
  {
    q: 'Does AI process my sensitive information?',
    a: "AI is used for tasks like reading receipts or extracting data from documents. The data is processed in real-time and sent directly to your own systems. We follow the Privacy Commissioner's guidance on AI use.",
  },
  {
    q: "What happens if there's a data breach?",
    a: 'Under the Privacy Act 2020, serious breaches must be reported to the Privacy Commissioner and affected individuals. Our automations include monitoring and alerts to help you detect and respond quickly.',
  },
  {
    q: 'Can I stop or remove an automation at any time?',
    a: "Absolutely. You own everything we build. No lock-in contracts, no vendor dependency. If you want to pause, modify, or remove any automation, you have full control.",
  },
  {
    q: 'Do you send data overseas?',
    a: "Some tools like Google and AI services operate globally. Where data crosses borders, we ensure it's handled in line with the Privacy Act's cross-border disclosure rules.",
  },
]
